                            ...
                            <div class="box-footer box-comments mt-3" style="display: block;">
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-lg-12 reply" style="display: none">
                                        <form action="{{ route('definition.comment.reply', $definition) }}" method="post">
                                            @csrf
                                            <div class="form-group">
                                    ...
                                    @if($comment->replies->first())
                                        @foreach($comment->replies as $reply)
                                            <div class="box-footer box-comments mt-3" style="display: block;">
                                                ...
                                                <div class="btn-group">
                                                    <form action="{{ route('definition.like.comment', $reply) }}" method="post">
                                                        @csrf
                                                        <button class="btn" type="submit"><i class="fas fa-thumbs-up"> {{ $reply->likes()->where('is_dislike', 0)->get()->count() }}</i></button>
                                                    </form>
                                                    <form action="{{ route('definition.dislike.comment', $reply) }}" method="post">
                                                        @csrf
